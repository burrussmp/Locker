define({ "api": [
      ...
      "fields": {
        "200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "data.liked",
            "description": "<p>Whether or not the requester liked this reply or not</p>"
          }
        ]
      },
      "examples": [
        ...
        "200": [
          {
            ...
            "optional": false,
            "field": "ID",
            "description": "<p>The ID of the deleted post</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "data.postedBy",
            "description": "<p>Who posted the comment (the user ID)</p>"
          },
          {
            "group": "200",
            "type": "Number",
          ...
          },
          {
            ...
            "optional": false,
            "field": "data.liked",
            "description": "<p>Whether or not the caller liked the comment</p>"
          }
        ]
      },
      "examples": [
        ...
        "200": [
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>The type of post (e.g. &quot;ProductPost&quot;)</p>"
          },
          {
            "group": "200",
            "type": "Object",
  ...
  {
    "type": "post",
    "url": "/api/posts?type=ProductPost",
    "title": "Create Product Post",
    "description": "<p>Create a new product post</p>",
    "name": "PostApiPosts",
    "group": "Post",
    "version": "0.1.0",
    "permission": [
    ...
    "sampleRequest": [
      {
        "url": "http://localhost:3000/api/posts?type=ProductPost"
      }
    ],
    "header": {
      "fields": {
